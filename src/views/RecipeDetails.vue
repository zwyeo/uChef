      ...
      <div class="row">
        <div class="col-12 col-md-8">
          <div class="receipe-headline my-5">
            <h2>{{ title }}</h2>
            <a class="btn video-btn delicious-btn" data-bs-toggle="modal" :data-src="video" data-bs-target="#myModal"
            ...
            <div v-for="(item, index) in ingredient_list" :key="index" :id="index">
              <ul class="list-group text-white">
                <li class="list-group-item d-flex justify-content-between align-content-center">
                  ...
                  <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
